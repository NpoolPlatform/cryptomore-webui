<template>
  ...
  <div class='content-width row horizontal-center'>
    ...
    <div class='right text-primary'>
      ...
      <p>You are aware that after deleting or canceling your information, we have the right to the relevant laws and regulations and network security considerations, to continue to save but not use your user information and other data.</p>
